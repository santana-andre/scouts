...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            <h1>Edit Page in <?php echo strtolower($content_language);?></h1>
            <?php echo form_open('',array('class'=>'form-horizontal'));?>
            <div class="form-group">
                <?php
                echo form_label('Parent page','parent_id');
                echo form_dropdown('parent_id',$parent_pages,set_value('parent_id',$page->parent_id),'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="form-group">
                ...
                echo form_input('order',set_value('order', $page->order),'class="form-control"');
                ?>
            </div>
            <div class="form-group">
                <?php
            ...
            <div class="form-group">
                ...
                echo form_textarea('content',set_value('content',$translation->content,false),'class="form-control"');
                ?>
            </div>
            ...
            <?php echo form_hidden('page_id',set_value('page_id',$translation->page_id));?>
